...
public class ImageUtilTest {
    ...
    @Test public void testRawElements() {
        Image image = (Image) Resources.lookup("test/util/image_1");
    ...
    @Test public void testCutImage() {
        Image expected = (Image) Resources.lookup("test/util/image_2");
        Image image = (Image) Resources.lookup("test/util/image_1");
    ...
    @Test public void testNegativeCut() {
        String expected = " ";
        Image before = (Image) Resources.lookup("test/util/image_1");
        Image result =
    ...
    @Test public void testDraw() {
        Image expected = (Image) Resources.lookup("test/util/canvas_after");
        Image before = (Image) Resources.lookup("test/util/canvas_after");
        Image toDraw = (Image) Resources.lookup("test/util/image_1");
    ...
    @Test public void testOverlap() {
        ...
        Image i = (Image) Resources.lookup("test/util/overlap_1");
        Image i2 = (Image) Resources.lookup("test/util/image_1");
